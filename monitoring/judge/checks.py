...
def check_deterministic_criteria(candidate_output: str, expected_criteria: Dict[str, List[str]] | None) -> Dict[str, Any]:
    """
    Deterministically checks if the candidate_output mentions required terms and avoids forbidden terms.
    """
